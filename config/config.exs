...
config :jido_managed_agents,
  ecto_repos: [JidoManagedAgents.Repo],
...
config :jido_managed_agents, JidoManagedAgents.Jido,
  max_tasks: 1000,
  agent_pools: []
...
config :jido_managed_agents, JidoManagedAgents.Sessions.SessionRuntime,
...
config :daisy_ui_components,
  translate_function: &JidoManagedAgentsWeb.CoreComponents.translate_error/1
...
config :jido_managed_agents, JidoManagedAgentsWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: JidoManagedAgentsWeb.ErrorHTML, json: JidoManagedAgentsWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: JidoManagedAgents.PubSub,
  live_view: [signing_salt: "r2qxDWKD"]
...
config :jido_managed_agents, JidoManagedAgents.Mailer, adapter: Swoosh.Adapters.Local
